  ...
  return {
    ...
    sendSelectNoOfRoomsMsg: async () => {
      ...
      const payload: CreateMessagePayload = {
        ...
        listDescription1: 'only 1RK room',
        listTitle1: '1RK',
        listDescription2: 'only 1BHK room',
        listTitle2: '1BHK',
        listDescription3: 'only 2BHK room',
        listTitle3: '2BHK',
        listDescription4: 'only 3BHK room',
        listTitle4: '3BHK',
        listDescription5: 'only 4BHK room',
        listTitle5: '4BHK',
        listDescription6: 'any no. of rooms',
        listTitle6: 'any',
      };
    ...
    sendSelectBudgetMsg: async () => {
      ...
      const payload: CreateMessagePayload = {
        ...
        listTitle1: '0 - 30k',
        listDescription2: 'Comfortable',
        listTitle2: '30k - 60k',
        listDescription3: 'Luxurious',
        listTitle3: '60k - above',
        listDescription4: 'any price',
        listTitle4: 'any',
      };
      await config.whatsappInstance.send(payload);
    },
    ...
    sendThresholdReachedMsg: async () => {
      const message =
        '⚠️ Oops!\n\nAapne 3 owners ke mobile number le liye hai. Isse adhik numbers lene ke liye aapko premium service leni hogi\n\nAdhik jaankaari ke liye 8810221503 pe sampark karein.';
      await sendTextMessage(
        config.whatsappInstance,
        message,
        config.userMetaData.phonenumber
