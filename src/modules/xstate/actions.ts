  ...
  return {
    ...
    sendSelectBudgetMsg: async () => {
      ...
      const payload: CreateMessagePayload = {
        ...
        listDescription1: 'Cheap',
        listTitle1: '0 - 20k',
        listDescription2: 'Budget-friendly',
        listTitle2: '20k - 40k',
        listDescription3: 'Moderate',
        listTitle3: '40k - 60k',
        listDescription4: 'Comfortable',
        listTitle4: '60k - 80k',
        listDescription5: 'Luxurious',
        listTitle5: '80k - above',
        listDescription6: 'any price',
        listTitle6: 'any',
      };
      await config.whatsappInstance.send(payload);
    },
